...
namespace AIEngine
{
    ...
    public:
         ...
         */
        template <typename T>
        std::vector<SceneNode *> FindNodesWithComponent();
         ...
         */
        void ForEachNode(std::function<void(SceneNode *)> func, bool activeOnly = false);
         ...
         * @param activeOnly If true, only process active nodes
         */
        void ForEachNode(std::function<void(const SceneNode *)> func, bool activeOnly = false) const;
         ...
         */
        template <typename T>
        void ForEachNodeWithComponent(std::function<void(SceneNode *, T *)> func, bool activeOnly = false);
    ...
    private:
         ...
         */
        void TraverseNodes(SceneNode *node, std::function<void(SceneNode *)> func, bool activeOnly);
         ...
         * @param activeOnly Only process active nodes
         */
        void TraverseNodes(const SceneNode *node, std::function<void(const SceneNode *)> func, bool activeOnly) const;
