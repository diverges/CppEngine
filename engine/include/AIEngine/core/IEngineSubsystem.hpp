 ...
 *
 * Subsystems provide the public interface for engine functionality while delegating
 * the actual implementation work to platform-specific providers. This design enables
 * cross-platform compatibility without requiring subsystem interface changes.
 *
