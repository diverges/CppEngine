...
const glm::vec3 FORWARD =
    glm::vec3(0.0f, 0.0f, -1.0f);                    // -Z (OpenGL convention)
 ...
 */
inline glm::mat4 CreateTRS(const glm::vec3 &position, const glm::quat &rotation,
 ...
 */
glm::quat CreateLookAtQuaternion(const glm::vec3 &from, const glm::vec3 &to,
 ...
 */
inline glm::quat SlerpQuaternion(const glm::quat &from, const glm::quat &to,
                                 float t) {
 ...
 */
inline bool AreEqual(const glm::vec3 &a, const glm::vec3 &b,
 ...
 */
bool DecomposeTRS(const glm::mat4 &matrix, glm::vec3 &translation,
 ...
 */
inline glm::mat4 CreateOrtho(float left, float right, float bottom, float top,
                             float nearPlane, float farPlane) {
 ...
 */
inline glm::mat4 CreateLookAt(const glm::vec3 &eye, const glm::vec3 &center,
                              const glm::vec3 &up = UP) {
